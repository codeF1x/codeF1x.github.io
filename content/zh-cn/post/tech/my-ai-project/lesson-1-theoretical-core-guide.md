+++
title = "第一课_理论核心指南"
date = 2025-12-26T00:40:00+08:00
draft = false
...
从传统前端转向 AI 架构师，核心在于思维模型的重构：

- **确定性 vs. 概率性**：传统开发是“输入 A 必得 B”的确定性逻辑；AI 架构则是构建“推理系统”，处理由大模型驱动的概率性输出。
- **能力重塑** ：
  - **上下文管理**：从管理 UI 状态转向管理 LLM 的有限注意力窗口（Token Window）。
